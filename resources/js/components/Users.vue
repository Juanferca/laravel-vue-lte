          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title p-2">User Table</h3>
                 <div class="card-tools">
                     <button class="btn btn-success" @click="newModal">Add new <i class="fas fa-user-plus fa-fw ml-2"></i></button>
                               ...
                               <tr v-for="user in users" :key="user.id">
                                 ...
                                 <td>
                                     <a href="#" @click="editModal(user)">
                                         <i class="fa fa-edit mr-1 green"></i>
                                    </a>
                                    <a href="#" @click="deleteUser(user.id)">
                                        <i class="fa fa-trash ml-1 red"></i>
                                    </a>
                                 </td>
                               </tr>     
                             </tbody>
                  ...
                  console.log('Creando')
                    ...
                    this.form.post('api/user')
                      ...
                      .then(() => {
                           ...
                           toast.fire({
                           icon: 'success',
                           title: 'User Create is successfully'                            
                    })
                    this.$Progress.finish();
