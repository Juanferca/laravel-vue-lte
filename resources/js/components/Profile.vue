    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user border">
                  ...
                  <div class="tab-pane active show" id="settings">
                    <form class="form-horizontal">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          <input type="passport" class="form-control" id="passport">
                      </div>
                        </div>
        ...
        methods: {
          ...
          updateProfile(e) {
            ...
            if(file['size'] < 215) {
              ...
              swal.fire('Ooopss.....','You are uploading a large file', 'error')
            }   
          }
